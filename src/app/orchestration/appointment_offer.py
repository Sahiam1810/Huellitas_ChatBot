...
def appointment_offer_choice(message: str) -> bool | None:
    ...
    is_negative = normalized in _NEGATIVE_CHOICES or re.search(r"\bno\b", normalized) is not None
    ...
    if is_negative and (is_explicitly_affirmative or has_booking_signal or has_date_signal):
        return None
    if is_negative:
        return False
